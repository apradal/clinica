<form action="" id="diseases-edit-form">
    <div class="row">
        <div class="col-12">
        ...
        <div class="col-12 col-md-6">
            ...
            <textarea name="heart_description" readonly id="heart_description">{{ $diseases['heart_description'] ?? '' }}</textarea>
        </div>
        <div class="col-12 col-md-6">
            ...
            <textarea name="osteoporosis_description" readonly id="osteoporosis_description">{{ $diseases['osteoporosis_description'] ?? '' }}</textarea>
        </div>
        <div class="col-12 col-md-6">
            ...
            <textarea name="liver_description" readonly id="liver_description">{{ $diseases['liver_description'] ?? '' }}</textarea>
        </div>
        <div class="col-12 col-md-6">
            ...
            <textarea name="cancer_description" readonly id="cancer_description">{{ $diseases['cancer_description'] ?? '' }}</textarea>
        </div>
        <div class="col-12 col-md-6">
            ...
            <textarea name="kidney_description" readonly id="kidney_description">{{ $diseases['kidney_description'] ?? '' }}</textarea>
        </div>
        <div class="col-12 col-md-6">
            ...
            <textarea name="hiv_description" readonly id="hiv_description">{{ $diseases['hiv_description'] ?? '' }}</textarea>
        </div>
        <div class="col-12 col-md-6">
            ...
            <textarea name="lung_description" readonly id="lung_description">{{ $diseases['lung_description'] ?? '' }}</textarea>
        </div>
        <div class="col-12 col-md-6">
        ...
        <div class="col-12 col-md-6">
            ...
            <textarea name="diabetes_description" readonly id="diabetes_description">{{ $diseases['diabetes_description'] ?? '' }}</textarea>
        </div>
        <div class="col-12 col-md-6">
            ...
            <textarea name="circulatory_description" readonly id="circulatory_description">{{ $diseases['circulatory_description'] ?? '' }}</textarea>
        </div>
        <div class="col-12 col-md-6">
            <label for="others_description">{{__('Otros')}}:</label>
            <textarea name="others_description" readonly id="others_description">{{ $diseases['others_description'] ?? '' }}</textarea>
        </div>
    </div>
</form>